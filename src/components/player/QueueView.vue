...
<template>
  <!-- Single root element on purpose: AppFrame swaps the views inside a
       <Transition mode="out-in">, and a multi-root fragment never fires its
       leave hook, which wedges the transition and blanks every other view. -->
