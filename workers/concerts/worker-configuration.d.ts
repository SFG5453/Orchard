/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed36ece97a18ae68c43aed8716fd93cb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TICKETMASTER_API_KEY">> {}
}
