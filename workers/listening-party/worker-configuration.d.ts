/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 84b918a67f3fb16daf2f91ee6c52d5ec)
// Runtime types generated with workerd@1.20260630.1 2026-06-30 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGIN: "*";
	ROOM_TTL_SECONDS: "43200";
	MAX_PARTICIPANTS: "12";
	PARTY_ROOM: DurableObjectNamespace<import("./src/index").ListeningPartyRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ListeningPartyRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGIN" | "ROOM_TTL_SECONDS" | "MAX_PARTICIPANTS">> {}
}
