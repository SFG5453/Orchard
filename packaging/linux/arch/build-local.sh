...
# node-smtc exposes Windows' System Media Transport Controls and is only an
# optional Windows integration. Rebuilding it on Arch fails because its native
# loader is not part of the Linux package.
rm -rf node_modules/node-smtc
